Feature: Delete task list
  ...
  Scenario Outline: Successfully delete a task list (normal flow)
    ...
    Examples:
      ...
      | anakinskywalker@gar.gov | doubting the order| See through the lies of the Jedi, Kill the younglings  |
      | anakinskywalker@gar.gov | fight people      | fight darth maul, Luke Skywalker                       |  
