      ...
      <el-row>
        <div class="card">
          ...
          >
            ...
            <el-row>
              <el-divider
                style="margin: 0px; padding: 0px; padding-bottom: 20px"
                >Sign Up
              </el-divider>
            </el-row>
            ...
            <button type="submit" class="submit" style="border-radius: 4px">
              Sign Up
            </button>

            <el-row justify="center">
              <p>
                Already have an account? Head back to
        ...
        axios_instance
          ...
          .catch((error) => {
            if (error.response.status === 409) {
              this.error =
                "Email already in use, please try logging in or using a different email";
            }
